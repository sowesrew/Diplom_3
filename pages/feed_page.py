...
class FeedPageBurger(BasePageBurger):
    def click_order(self):
        self.driver.find_element(*FeedPageLocators.LAST_ORDER).click()

    def window_order(self):
        element = self.driver.find_element(*FeedPageLocators.HEAD_STRUCTURE)
        return element
    ...
    def click_constructor(self):
        self.driver.find_element(*FeedPageLocators.P_KONSTRUCTOR).click()
